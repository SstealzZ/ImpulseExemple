...
const char* ei_classifier_inferencing_categories[] = { "Critical", "High", "Low", "Mid" };
...
const ei_impulse_t impulse_514720_0 = {
    .project_id = 514720,
    .project_owner = "Antoine Veber",
    .project_name = "SstealzZ-project-1",
    .impulse_id = 1,
    .impulse_name = "Impulse #1",
    .deploy_version = 5,

    .nn_input_frame_size = 1,
    .raw_sample_count = 1,
...
ei_impulse_handle_t impulse_handle_514720_0 = ei_impulse_handle_t( &impulse_514720_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_514720_0;
